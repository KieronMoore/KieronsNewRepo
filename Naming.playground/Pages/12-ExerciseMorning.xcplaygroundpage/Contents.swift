...
let totalAmountOfTime = brushTeeth + shower + getttingDreesed + finishHomework
...
let thingsIHaveToDo = brushTeeth + shower + getttingDreesed

let thingsIWantToDo = finishHomework + sleepMore
/*:
